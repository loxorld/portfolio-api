...
public class Project {
    ...
    // getters/setters (o Lombok si preferís)
    ...
    public Set<String> getStack() { return stack; }
    public void setStack(Set<String> stack) { this.stack = stack; }
